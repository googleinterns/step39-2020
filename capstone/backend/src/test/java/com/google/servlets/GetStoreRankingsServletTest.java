...
public class GetStoreRankingsServletTest extends TestCase {
  ...
  public void testRankStores() throws ServletException, IOException {
    ...
    String expected =
        "[{\"lowestPotentialPrice\":22.28,\"totalItemsFound\":1,\"totalUnavailableItemsFound\":0,\"storeId\":1,\"items\":{\"MILK\":[{\"itemId\":\"1\",\"storeId\":1,\"itemPrice\":11.98,\"itemBrand\":\"Horizon\",\"itemName\":\"Organic Whole Shelf-Stable Milk, 8 Oz., 12 Count\"},{\"itemId\":\"2\",\"storeId\":1,\"itemPrice\":10.3,\"itemBrand\":\"Natrel\",\"itemName\":\"Whole Milk, 32 fl oz\"}]},\"typeToPrice\":{\"MILK\":10.3},\"storeAddress\":\"3255 Mission College Blvd\",\"storeName\":\"Walmart\"},"
            + "{\"lowestPotentialPrice\":10.38,\"totalItemsFound\":1,\"totalUnavailableItemsFound\":0,\"storeId\":2,\"items\":{\"MILK\":[{\"itemId\":\"1\",\"storeId\":2,\"itemPrice\":10.38,\"itemBrand\":\"Horizon\",\"itemName\":\"Organic Whole Shelf-Stable Milk, 8 Oz., 12 Count\"}]},\"typeToPrice\":{\"MILK\":10.38},\"storeAddress\":\"4080 Stevens Creek Blvd\",\"storeName\":\"Target\"},"
            + "{\"lowestPotentialPrice\":9.44,\"totalItemsFound\":1,\"totalUnavailableItemsFound\":0,\"storeId\":3,\"items\":{\"MILK\":[{\"itemId\":\"2\",\"storeId\":3,\"itemPrice\":9.44,\"itemBrand\":\"Natrel\",\"itemName\":\"Whole Milk, 32 fl oz\"}]},\"typeToPrice\":{\"MILK\":9.44},\"storeAddress\":\"301 Ranch Dr\",\"storeName\":\"Whole Foods\"}]";

...
public final class LibraryFunctionsTest {
    ...
    databaseClient
        ...
        .run(
            new TransactionCallable<Void>() {
              ...
              public Void run(TransactionContext transaction) throws Exception {
                String[] sql = {
                  "INSERT INTO Items (ItemId, ItemNameAndBrand, ItemType) VALUES (1, 'Horizon"
                      + " Organic Whole Shelf-Stable Milk, 8 Oz., 12 Count', 'MILK'), (2, 'Natrel"
                      + " Whole Milk, 32 fl oz', 'MILK'), (3, 'FIJI Natural Artesian Water,16.9 Fl"
                      + " Oz, 24 Ct', 'WATER'), (4, 'General Mills, Cheerios, Gluten Free,"
                      + " Breakfast Cereal, Family Size 18 oz Box', 'CEREAL'), (5, 'OZARKA Brand"
                      + " 100% Natural Spring Water, 16.9-ounce plastic bottles', 'WATER') ",
  ...
  public void getStoresForTwoItemTypes() {
    ...
    store2.addItem(
        5, 9.98, "OZARKA Brand 100% Natural Spring Water, 16.9-ounce plastic bottles", "WATER");
    store2.addItem(1, 10.38, "Horizon Organic Whole Shelf-Stable Milk, 8 Oz., 12 Count", "MILK");
    store3.addItem(2, 9.44, "Natrel Whole Milk, 32 fl oz", "MILK");
    expected.add(store1);
    expected.add(store2);
